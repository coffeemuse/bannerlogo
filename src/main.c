...
int main(int argc, char* argv[]) {
    ...
    putch(' '); 
    putch(204); putch(205); putch(206); putch(207);
    mos_puts("\r\n", 0, '\0');

    putch(208); putch(209); putch(210); putch(211); putch(212); putch(213);
    mos_puts("\r\n", 0, '\0');
    
    putch(214); putch(215); putch(216); putch(209); putch(217); putch(218);
    ...
    putch(219); putch(220); putch(221); putch(222); putch(223); putch(224);
    printf("        Text: %d x %d\r\n", getsysvar_scrCols(), getsysvar_scrRows());

    putch(225); putch(226); putch(227); putch(228); putch(229); putch(230);
    printf("    Graphics: %d x %d\r\n", getsysvar_scrwidth(), getsysvar_scrheight());

    putch(231); putch(232); putch(233); putch(234); putch(235); putch(236);
